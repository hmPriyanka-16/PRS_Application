<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="hold.aspx.cs" Inherits="PRSwebapp.hold" %>
...
<div style="width:270px; display:flex; align-items:center; gap:5px;">
    ...
    <div class="text-center flex-grow-1">
        <h5 class="mb-0 fw-bold">Hold PRS</h5>
    </div>
                   ...
                   OnRowCommand="gvMainPending_RowCommand"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="PRS No">
                            <ItemTemplate>
                                <a href="javascript:void(0);" class="text-primary fw-bold" onclick='openPRSModal("<%# Eval("PRSNo") %>");'>  <%# Eval("PRSNo") %> </a>
                            </ItemTemplate>
                        </asp:TemplateField>
           ...
           onclick='<%# "openDocsModal(\"" + Eval("PONumber") + "\");" %>'>
            <i class="bi bi-file-earmark-text"></i>
                        ...
                        <asp:TemplateField HeaderText="Hold By">
                            ...
                            <ItemTemplate>
                           <asp:Label ID="Lbl_Hold" runat="server" 
    Text='<%# Bind("LastAction") %>'></asp:Label>

<asp:Label ID="Lbl_last_action" runat="server" 
    Text='<%# Bind("Last_Sequence") %>' Visible="false"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
