<%@ Page Title="Reject/Hold Tasks" Language="C#" MasterPageFile="~/SiteMaster.Master"
    AutoEventWireup="true" CodeBehind="rejecthold.aspx.cs" Inherits="PRSwebapp.rejecthold" %>
...
<div style="width:270px; display:flex; align-items:center; gap:5px;">
    ...
    <div class="text-center flex-grow-1">
        <h5 class="mb-0 fw-bold">Rejected PRS</h5>
    </div>
...
<asp:BoundField DataField="LastAction" HeaderText="Rejected By" />
